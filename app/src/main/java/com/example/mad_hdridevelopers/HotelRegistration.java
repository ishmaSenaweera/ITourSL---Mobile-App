...
public class HotelRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactno = (TextInputEditText) findViewById(R.id.hotelContactTV);
        location = (TextInputEditText) findViewById(R.id.hotelLocationTV);
        pageurl = (TextInputEditText) findViewById(R.id.hotelUrlTV);
        ...
        signup = (Button) findViewById(R.id.hotelCreateBtn);

        choose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dexter.withActivity(HotelRegistration.this)
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        uploader.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                DatabaseReference root=db.getReference("Hotel");
                                ...
                                root.child(name.getText().toString()).setValue(hotel);
